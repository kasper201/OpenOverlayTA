...
<div class="container"><div class="bracketWrapper" bind:this={bracketElement} style="transform: translateX({bracketX}px); cursor: {isDragging ? 'grabbing' : 'grab'};" on:mousedown={handleMouseDown} role="button" tabindex="0"><iframe title="ChalloneBracket" src="https://challonge.com/bs_elites/module?theme=2&scale_to_fit=1" class="bracket" allowTransparency={true} frameBorder="1" scrolling="auto" style="width: 72vw; height: 100vh; border: none; pointer-events: none;"></iframe></div></div>
